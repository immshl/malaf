            ...
            <CardContent className="p-10 lg:p-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                {profile.website && (
                  ...
                  >
                    <div className="w-8 h-8 bg-green-500/10 rounded-full flex items-center justify-center mb-2 group-hover:bg-green-500/20 transition-smooth">
                ...
                {profile.instagram_url && (
                  <a 
                    ...
                    className="aspect-square flex flex-col items-center justify-center p-4 rounded-2xl bg-background/60 hover:bg-background/80 backdrop-blur-sm transition-all duration-200 border border-border/20 hover:border-border/40 group shadow-sm hover:shadow-md"
                  >
                    <div className="w-8 h-8 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full flex items-center justify-center mb-2 group-hover:from-purple-500/20 group-hover:to-pink-500/20 transition-smooth">
                ...
                {profile.linkedin_url && (
                  <a 
                    ...
                    className="aspect-square flex flex-col items-center justify-center p-4 rounded-2xl bg-background/60 hover:bg-background/80 backdrop-blur-sm transition-all duration-200 border border-border/20 hover:border-border/40 group shadow-sm hover:shadow-md"
                  >
                    <div className="w-8 h-8 bg-blue-600/10 rounded-full flex items-center justify-center mb-2 group-hover:bg-blue-600/20 transition-smooth">
                ...
                {profile.github_url && (
                  <a 
                    ...
                    className="aspect-square flex flex-col items-center justify-center p-4 rounded-2xl bg-background/60 hover:bg-background/80 backdrop-blur-sm transition-all duration-200 border border-border/20 hover:border-border/40 group shadow-sm hover:shadow-md"
                  >
                    <div className="w-8 h-8 bg-gray-500/10 rounded-full flex items-center justify-center mb-2 group-hover:bg-gray-500/20 transition-smooth">
